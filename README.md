...
## *3. Clion, PyCharm*
---
### Реализованы 4/3 алгоритмов поиска вхождений строки-шаблона в тексте, вдобавок 4 их модификации для шаблонов, содержащих символы подстановки [?], есть функция проверки корректности работы алгоритмов, есть генератор 2-ух видов текстов, 2 вида размера текстов, присутствует измерение времени выполнения, а ещё в коде есть комментарии. Опять получилось много графиков и табличек. Результаты работы проанализировала и интерпретировала в отчёте. В общем, сделала всё.
